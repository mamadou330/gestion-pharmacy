...
<div class="row m-4">
    ...
    <div class="col-6 col-md-3">
        <button type="button" class="bg-indigo border border-indigo-600 p-3 rounded-lg" data-toggle="modal"
            data-target="#productModal" data-whatever="@fat"><i class="fas fa-cart-plus mx-1"></i> Ajouter un
            Produit</button>
                        ...
                        <div class="modal-body">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="produit"
                                    ...
                                    value="{{ old('produit')}}" placeholder="Ex: Paracetamol" required autofocus
                                    autocomplete>
                                @error('produit')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right py-0 align-middle">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-xs viewOrder"
                                            data-toggle="modal" data-target=".bs-show-modal-lg"><i
                                                class="fa fa-folder-open" data-toggle="tooltip" data-placement="top"
                                                title="Voir"></i></button>
                                        <button type="submit" class="btn btn-info btn-xs editOrder" data-toggle="modal"
                                            data-target=".bs-editorder-modal-lg" data-backdrop="static"
                                            data-keyboard="false"><i class="fas fa-pen" data-toggle="tooltip"
                                                data-placement="top" title="Modifier"></i></button>
                                        <button type="submit" class="btn btn-danger btn-xs deleteOrder"
                                            data-method="DELETE" data-confirm="Etes-vous sûr"><i class="fas fa-trash"
