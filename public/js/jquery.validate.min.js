    ...
    c.extend(c.validator, {
        ...
        prototype: {
            ...
            getLength: function(a, b) {
                switch (b.nodeName.toLowerCase()) {
                    ...
                    case "input":
                        if (this.checkable(b))
                            return this.findByName(b.name).filter(":checked")
                                .length;
                }
                return a.length;
            },
            ...
            optional: function(a) {
                return (
                    !c.validator.methods.required.call(
                        this,
                        c.trim(a.value),
                        a
                    ) && "dependency-mismatch"
        ...
        addMethod: function(a, b, d) {
            ...
            c.validator.messages[a] =
                d != undefined ? d : c.validator.messages[a];
            b.length < 3 &&
                ...
                c.ajax(
                    c.extend(
                        true,
                        {
                            ...
                            data: g,
                            success: function(h) {
                                f.settings.messages[b.name].remote =
                                    e.originalMessage;
                                var j = h === true;
                                if (j) {
            ...
            accept: function(a, b, d) {
                d =
                    typeof d == "string"
                        ...
                        : "png|jpe?g|gif";
                return (
                    this.optional(b) || a.match(RegExp(".(" + d + ")$", "i"))
                );
            },
